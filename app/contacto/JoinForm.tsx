...
export default function JoinForm() {
  ...
  return <><section className="join-page-hero"><div><p className="section-index">05 — Contacto</p><p className="eyebrow"><span /> Tu voz también construye</p><h1>Hay un lugar<br />para <em>vos.</em></h1><p>Completá tus datos y nos pondremos en contacto para coordinar una audición de ingreso. No hace falta pertenecer a la Facultad para participar.</p></div><aside><div><small>Ensayos</small><strong>Todos los viernes<br />19:30 — 22:00 h</strong></div><div><small>Lugar</small><strong>Av. Paseo Colón 850</strong><a href="https://maps.app.goo.gl/p9ZfPAG2v7PEmbyP6" target="_blank" rel="noreferrer">Abrir en Maps ↗</a></div></aside></section>
