...
const concertCycle = concertSet(
  [8,19,24,33,38,39],
  ["El Ciclo de Conciertos Corales en la sede Las Heras.","El Coro FIUBA compartiendo escenario con agrupaciones invitadas.","Una jornada del ciclo organizado por el Coro FIUBA."]
);

const rehearsals = concertSet(
  [6,9,10],
  ["Ensayo del Coro FIUBA en la Facultad.","Preparación musical antes de una presentación.","Trabajo de voces y dirección durante el ensayo."]
);
...
const otherStages = concertSet(
  ...
  ["El Coro FIUBA en uno de sus escenarios invitados.","Una presentación coral fuera del ciclo de Las Heras.","Encuentros y conciertos que forman parte de nuestra historia."]
);
