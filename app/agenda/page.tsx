...
export const metadata = pageMetadata("Agenda de conciertos 2026", "Agenda 2026 del Coro de la Facultad de Ingeniería UBA: conciertos corales, Noche de los Museos y presentaciones de la Facultad de Ingeniería UBA.", "/agenda");
