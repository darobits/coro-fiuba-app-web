    ...
    "@graph": [
      {
        ...
        "@id": `${SITE_URL}/#website`,
        url: SITE_URL,
        name: "Coro de la Facultad de Ingeniería UBA",
        alternateName: ["Coro FIUBA", "Coro de la Facultad de Ingeniería", "Coro Ingeniería UBA", "Coro Facultad de Ingeniería", "Coro de Ingeniería de la UBA", "FIUBA Coro", "corofiuba.com.ar"],
        inLanguage: "es-AR",
      ...
      },
      {
        ...
        "@id": organizationId,
        name: "Coro de la Facultad de Ingeniería UBA",
        alternateName: ["Coro FIUBA", "Coro de la Facultad de Ingeniería", "Coro Ingeniería UBA", "Coro Facultad de Ingeniería", "Coro de Ingeniería de la UBA", "FIUBA Coro"],
        url: SITE_URL,
        ...
        logo: {
          "@type": "ImageObject",
          url: `${SITE_URL}/logo-fiuba2.png`,
          contentUrl: `${SITE_URL}/logo-fiuba2.png`,
          width: 1254,
          height: 1254,
        },
...
export function AgendaStructuredData({ events }: { events: AgendaEvent[] }) {
  const data = {
    ...
    "@graph": events.map(event => ({
      ...
      performer: [{ "@id": organizationId }, ...(event.participants ?? []).map(participant => ({ "@type": "MusicGroup", name: participant.name }))],
    })),
  };
